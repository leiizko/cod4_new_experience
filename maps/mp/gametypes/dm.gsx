...
main()
{
	...
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( level.gameType, 1000, 0, 10000000 );
...
onStartGameType()
{
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "kill", 10 * level.dvar[ "xp_multi" ] );
	maps\mp\gametypes\_rank::registerScoreInfo( "headshot", 10 * level.dvar[ "xp_multi" ] );
