	...
	*/
	...
	{	
		...
		if ( secondaryWeapon != "" )
		{
			...
			if( level.dvar[ "disable_rpg" ] && secondaryWeapon == "rpg_mp" )
				self SetActionSlot( 3, "" );
			else if( level.dvar[ "disable_c4" ] && secondaryWeapon == "c4_mp" )
				self SetActionSlot( 3, "" );
			else
